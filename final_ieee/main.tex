...
\begin{enumerate}
  ...
  \item \textbf{Three negative engineering findings}: ensemble disagreement never helped; logistic regression stacking beat all neural aggregators; and learned aggregation degrades under distribution shift.
